...
local OrionLib = {
    ...
    Themes = {
        ...
        Midnight = {
            Main = Color3.fromRGB(10, 10, 20), -- Fundo escuro com tom azulado
            Second = Color3.fromRGB(20, 20, 40), -- Segunda cor mais escura
            Stroke = Color3.fromRGB(80, 80, 120), -- Bordas azuladas
            Divider = Color3.fromRGB(80, 80, 120), -- Divisórias azuladas
            Text = Color3.fromRGB(220, 220, 240), -- Texto claro
            TextDark = Color3.fromRGB(150, 150, 180) -- Texto escuro
        },
        Sunset = {
            Main = Color3.fromRGB(30, 10, 10), -- Fundo escuro com tom avermelhado
            Second = Color3.fromRGB(50, 20, 20), -- Segunda cor mais escura
            Stroke = Color3.fromRGB(120, 60, 60), -- Bordas avermelhadas
            Divider = Color3.fromRGB(120, 60, 60), -- Divisórias avermelhadas
            Text = Color3.fromRGB(240, 200, 200), -- Texto claro
            TextDark = Color3.fromRGB(180, 120, 120) -- Texto escuro
        },
        Ocean = {
            Main = Color3.fromRGB(10, 20, 30), -- Fundo escuro com tom azul-esverdeado
            Second = Color3.fromRGB(20, 40, 60), -- Segunda cor mais escura
            Stroke = Color3.fromRGB(60, 120, 150), -- Bordas azul-esverdeadas
            Divider = Color3.fromRGB(60, 120, 150), -- Divisórias azul-esverdeadas
            Text = Color3.fromRGB(200, 240, 240), -- Texto claro
            TextDark = Color3.fromRGB(120, 180, 180) -- Texto escuro
        },
        Neon = {
            Main = Color3.fromRGB(0, 0, 0), -- Fundo preto
            Second = Color3.fromRGB(10, 10, 10), -- Segunda cor preta
            Stroke = Color3.fromRGB(255, 0, 255), -- Bordas neon (rosa)
            Divider = Color3.fromRGB(255, 0, 255), -- Divisórias neon (rosa)
            Text = Color3.fromRGB(255, 255, 255), -- Texto branco
            TextDark = Color3.fromRGB(200, 200, 200) -- Texto cinza claro
        },
        Pastel = {
            Main = Color3.fromRGB(240, 240, 240), -- Fundo branco pastel
            Second = Color3.fromRGB(220, 220, 220), -- Segunda cor branca
            Stroke = Color3.fromRGB(180, 180, 180), -- Bordas cinza claro
            Divider = Color3.fromRGB(180, 180, 180), -- Divisórias cinza claro
            Text = Color3.fromRGB(50, 50, 50), -- Texto escuro
            TextDark = Color3.fromRGB(100, 100, 100) -- Texto cinza
        }
    },
...
function OrionLib:MakeWindow(WindowConfig)
    ...
    WindowConfig.Name = WindowConfig.Name or "Test Hub"
    ...
    WindowConfig.IntroText = WindowConfig.IntroText or "Test Script"
...
local MobileIcon =
    SetChildren(
    SetProps(
        MakeElement("ImageButton", "http://www.roblox.com/asset/?id=103928780885515"),
        {
...
function Functions:MakeTab(TabConfig)
    ...
    function Functions:AddSection(SectionConfig)
